...
2a. **提问以特殊疑问句（Wh-questions）为主**：优先使用 What / Where / When / Who / Why / How 提问语料里的具体信息（如 "What time does the restaurant open?" "Where did you swim this morning?" "How can I get to my room?" "Why did she bring a big suitcase?"）。这类问题**迫使学生产出完整句子和核心词汇**，而不是一句 "Yes / No" 糊弄过去。一般疑问句（Yes/No）每 3 轮最多 1 次，且用完后的下一轮必须跟进一个 Wh- 追问。
